...
import { postComments } from '../assets/user';
        ...
        <div className='w-full py-3'>
            <div className='flex gap-3 items-center mb-1'>
                <Link to={'/profile/'+reply?.userId?._id}>
                    <img
                        src={reply?.userId?.profile ?? NoProfile}
            ...
            <div className='flex items-end justify-end pb-2'>
                {loading?(
                    ...
                    <CustomButton
                        title='Submit'
                        type='submit'
                        containerStyles='bg-[#444a4] text-white py-1 px-3 rounded-full font-semibold text-sm'
                    />
                )}
            </div>
        </form>
...
const PostCard = ({post, user, deletePost, likePost}) => {
    ...
    return(
        <div className='mb-2 bg-primary p-4 rounded-xl'>
            ...
            {/* comments */}
            {/* if there is any doubt create in comment system see lec 3:45-50 */}
            {showComments === post?._id && (
                <div className='w-full mt-4 border-t border-j[#66666645] pt-4'>
                    <CommentForm
                        user={user}
                        id={post?._id}
                                    ...
                                    {showReply === comment?.replies?._id && comment?.replies?.map((reply)=>(
                                        <ReplyCard
                                            ...
                                            handleLike={() => handleLike(
                                                '/posts/like-comment/'+comment?._id+'/'+reply?.id
                                            )}
                                        />
                                    ))}
                                </div>
