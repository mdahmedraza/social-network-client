...
import {ProfileCard, FriendsCard, CustomButton, Loading, TopBar, TextInput, PostCard, EditProfile} from '../components';
import {suggest, requests, posts} from '../assets/user';
                ...
                <div className='flex-1 h-full px-4 flex flex-col gap-6 overflow-y-auto rounded-lg'>
                    <form onSubmit={handleSubmit(handlePostSubmit)} className='bg-primary px-4 rounded-lg'>
                        ...
                        <div className='flex items-center justify-between py-4'>
                            <label
                                htmlFor='imgUpload'
                                className='flex items-center gap-1 text-base text-ascent-2 hover:textascent-1 cursor-pointer'
                            >
                                <input
                                    type='file'
